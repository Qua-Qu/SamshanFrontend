            ...
            <div className="row">
              <div className="col-md-4 mb-4 mb-md-0">
                <NavLink className="category-item" to="/shop">
                  <img
                    className="img-fluid"
                    src="/image/combed-28s.jpg"
                    alt=""
                  />
                  <strong className="category-item-title">Cotton Combed</strong>
                </NavLink>
              </div>
              <div className="col-md-4 mb-4 mb-md-0">
                <NavLink className="category-item mb-4" to="/shop">
                  <img className="img-fluid" src="/image/bamboo1.jpg" alt="" />
                  <strong className="category-item-title">Cotton Bamboo</strong>
                </NavLink>
                <NavLink className="category-item" to="/shop">
                  <img
                    className="img-fluid"
                    src="/image/polyster.png"
                    alt=""
                  />
                  <strong className="category-item-title">Polyster</strong>
                </NavLink>
              </div>
              <div className="col-md-4">
                <NavLink className="category-item" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Cotton Flece</strong>
                </NavLink>
              </div>
            </div>
          </div>
